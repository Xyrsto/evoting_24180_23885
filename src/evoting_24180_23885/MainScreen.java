...
public class MainScreen extends javax.swing.JFrame {
    ...
    //hashmap(key = userEncriptado, data = lista)
    ...
    public void loadVotos() {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("votes/votesCurState.votes"))) {
            votos = (ArrayList) ois.readObject();
        } catch (Exception err) {
    ...
    public void getLoggedUser(String numCC, String password) throws Exception {
        ...
        if (loggedUser.getHasVoted(allVotes)) {
            userHasVoted = true;
        }
    }
    ...
    public void addEncryptedVote(Voto vote) throws Exception {
        ...
        String key = Base64.getEncoder().encodeToString(vote.getEleitor());
        String data = Base64.getEncoder().encodeToString(vote.getBytes(pubKey));
        votos.add(vote);
        allVotes.put(key, data);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            System.out.println(loggedUser.getHasVoted(allVotes));
        } catch (Exception ex) {
        ...
        if (votos.size() <= 10) {
            ...
            try {
                ...
                Voto vote = new Voto(encryptedUser, partido.getNome());
